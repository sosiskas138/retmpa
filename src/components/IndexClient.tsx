...
import { FilterState, Company, RoadmapEvent, Founder, IPOData, FinancialData } from "@/types/retail";
import { Store, Building2, TrendingUp, Filter, BarChart3, Users, UserCog, Settings } from "lucide-react";
...
export default function IndexClient({ initialData }: IndexClientProps) {
  ...
  const { companies, events: allEvents, founders: allFounders, ipoData: allIPO, financials: allFinancials, isApiConfigured } = initialData;
